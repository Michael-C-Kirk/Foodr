...
BASE_URL_LOCATION = 'http://api.ipstack.com/'
...
def call(IP: str, radius: str, keyword: str) -> dict:
    location_url = BASE_URL_LOCATION + IP + "?access_key=7120c43786f9366307ba898849beb2c2"
    location = get_result(location_url)
